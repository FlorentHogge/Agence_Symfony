...
class Property
{
    ...
    /**
     * @var File|null
     * @Assert\Image(mimeTypes="image/jpeg", mimeTypesMessage="L'image doit être sous le format JPEG.")
    ...
    /**
     * @Assert\Regex("/^[0-9]{4}$/", message="Le code doit contenir 4 chiffres")
     * @ORM\Column(type="string", length=255)
     */
    private $postal_code;
    ...
    /**
     * Fonction qui va permettre d'afficher le titre dans l'URL plus tard
     */
